    ...
    <footer>
		...
		<div class="foot-copyright" style="font-size: 12px;">{{.aOut.Title}}'s contents are all uploaded from the Internet and users. Please contact us to delete them if they are infringing {{str2html .aOut.StatisticsCode}}</div>
    </footer>
